...
export const tasks = [
    new Task({ Id: 1, ProjectId: 1, Name: "Design Homepage", Urgency: 0, Status: 0 }),
    new Task({ Id: 2, ProjectId: 1, Name: "Develop Backend", Urgency: 2, Status: 1 }),
    new Task({ Id: 3, ProjectId: 1, Name: "Setup Database", Urgency: 1, Status: 2 }),
    new Task({ Id: 4, ProjectId: 1, Name: "Write Documentation", Urgency: 0, Status: 3 }),
    new Task({ Id: 5, ProjectId: 1, Name: "Deploy to Production", Urgency: 2, Status: 4 }),

    new Task({ Id: 6, ProjectId: 2, Name: "Market Research", Urgency: 1, Status: 0 }),
    new Task({ Id: 7, ProjectId: 2, Name: "Create Ad Campaign", Urgency: 2, Status: 1 }),
    new Task({ Id: 8, ProjectId: 2, Name: "Social Media Strategy", Urgency: 1, Status: 2 }),
    ...
    new Task({ Id: 12, ProjectId: 3, Name: "UI Mockups", Urgency: 0, Status: 1 }),
    new Task({ Id: 13, ProjectId: 3, Name: "API Integration", Urgency: 2, Status: 2 }),
    new Task({ Id: 14, ProjectId: 3, Name: "Testing", Urgency: 1, Status: 3 }),
    ...
    new Task({ Id: 17, ProjectId: 4, Name: "Requirements Gathering", Urgency: 1, Status: 1 }),
